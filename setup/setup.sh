...
#echo "COPY ${app_name}_sentences_nlp FROM '/input/sentences_nlp'" | psql -U $postgres__user -h $postgres__host -p $postgres__port $postgres__database
...
echo "COPY ${app_name}_sentences_nlp352 FROM '/input/sentences_nlp352'" | psql -U $postgres__user -h $postgres__host -p $postgres__port $postgres__database
...
echo "COPY ${app_name}_sentences_nlp352_bazaar FROM '/input/sentences_nlp352_bazaar'" | psql -U $postgres__user -h $postgres__host -p $postgres__port $postgres__database
